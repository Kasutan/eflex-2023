...
function kasutan_header_top() {
	...
	if(function_exists('get_field')) {
		$logo=esc_attr(get_field('eflex_logo_header','option'));
		$resa_mobile=esc_attr(get_field('eflex_resa_label_mobile','option'));
		$resa_desktop=esc_attr(get_field('eflex_resa_label_desktop','option'));
		$resa_url=esc_url(get_field('eflex_resa_cible','option'));
	}
